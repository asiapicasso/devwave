<template>
    <div id="pageReglage" :class="{'blur-background': showLogoutPopup || showDeletePopup}">
      ...
      <button v-if="!inSettingPage" @click="displaySettingPage()"><img src="../../assets/back.png" class="absolute left-0 w-10 h-10 ml-2"/></button>
        ...
        <div class="">
            <p class="text-center">Choisis une photo de profil 🐱🚀</p>
        </div>
        <div id="galleryImage" class="flex flex-wrap justify-center mt-5">
            <div class="flex items-center">
                <img src="../../assets/profils-01.png" class="h-20 w-20" />
                <img src="../../assets/profils-02.png" class="h-20 w-20" />
                <img src="../../assets/profils-03.png" class="h-20 w-20" />
                <img src="../../assets/profils-04.png" class="h-20 w-20" />
            </div>
            <div class="flex items-center">
                <img src="../../assets/profils-05.png" class="h-20 w-20" />
                <img src="../../assets/profils-06.png" class="h-20 w-20" />
                <img src="../../assets/profils-07.png" class="h-20 w-20" />
                <img src="../../assets/profils-08.png" class="h-20 w-20" />
            </div>
            <div class="flex items-center">
                <img src="../../assets/profils-09.png" class="h-20 w-20" />
                <img src="../../assets/profils-10.png" class="h-20 w-20" />
                <img src="../../assets/profils-11.png" class="h-20 w-20" />
                <img src="../../assets/profils-12.png" class="h-20 w-20" />
            </div>
            <div class="flex items-center">
                <img src="../../assets/profils-13.png" class="h-20 w-20" />
                <img src="../../assets/profils-14.png" class="h-20 w-20" />
                <img src="../../assets/profils-15.png" class="h-20 w-20" />
                <img src="../../assets/profils-16.png" class="h-20 w-20" />
            </div>
        </div>
    </div>
    <div>
