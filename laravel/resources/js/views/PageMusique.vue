<template>
    ...
    <div>
        ...
        <div class="flex flex-col">
            <BaseVoteMusique v-for="(song, index) in chosenSong" :key="index" :text="song.title + '-' + song.votes"
                @upvote="handleUpvote(index)" @downvote="handleDownvote(index)" iconUp='<svg width="20" height="23" viewBox="0 0 20 23" xmlns="http://www.w3.org/2000/svg">
...
</svg>' :score="song.votes"></BaseVoteMusique>
        </div>
    </div>
</template>
