  ...
  <div class="container">
    <div class="card">
      ...
      <div class="flex fixed w-full bottom-32 bg-gris-1 bg-opacity-75 items-center">
        ...
        <input id="btn-input" type="text" name="message" class="pl-2 form-control input-sm ml-3 mr-3 flex-grow"
          placeholder="T'en penses quoi?" v-model="newMessage" @keyup.enter="sendMessage" />
        <div class="flex items-center">
          <span class="input-group-btn mr-2">
            <button class="btnSend w-9 bg-gradient-to-t from-bleu-clair via-middle-rose to-rose rounded-md"
              @click="sendMessage">
