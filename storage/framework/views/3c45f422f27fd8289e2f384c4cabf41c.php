...
unset($__errorArgs, $__bag); ?>" name="lastname" value="<?php echo e(old('lastname')); ?>" required autocomplete="lastname">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
<!--     <label for="photo" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Photo')); ?></label>
    ...
    <div class="col-md-6">
        ...
        <?php for($i = 1; $i <= 20; $i++): ?>
                <label class="photo-item">
                    <input type="radio" name="photo" value="<?php echo e('storage/assets/profile_pictures/default/picture' . $i . '.png'); ?>" />
                    <img src="<?php echo e(asset('storage/assets/profile_pictures/default/picture_' . $i . '.png')); ?>" alt="Image <?php echo e($i); ?>" />
                </label>
            <?php endfor; ?>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\git\devwave_perso\resources\views/auth/register.blade.php ENDPATH**/ ?>